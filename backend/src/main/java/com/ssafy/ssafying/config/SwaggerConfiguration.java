...
//	http://localhost:8000/swagger-ui.html
	...
	public Docket api() {
		...
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).groupName(version).select()
					.apis(RequestHandlerSelectors.basePackage("com.ssafy.ssafying.controller"))
...
//		return regex("/admin/.*");
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title(title)
				.description("<h3>Swagger Api for Developers</h3>Swagger를 이용한 VUEJS API<br><img src=\"ssafy.png\">") 
