<template>
  <v-container>
    ...
    <div class="market__header">
      <h3><b>우리만의 중고장터, 싸피장터</b></h3>
    </div>

    <!-- 컴포넌트 router -->
    <div class="community__links">
      <div class="btn__group">
        <v-btn id="active" value="전체" to="/board/market">전체</v-btn>
        <v-btn value="삽니다" to="/board/buy"> 삽니다 </v-btn>
        <v-btn value="팝니다" to="/board/sell">팝니다 </v-btn>
              ...
              <v-col>
                <div class="d-flex justify-content-between mt-4">
                  ...
                  <span class="card__category">
                    {{ article.articleDto.location }}</span
                  >
                ...
                <!-- 내용 -->
                <div class="content market__content__font mt-3">
                  <div>
...
// import MarketList from "@/components/board/market/MarketList.vue";
  ...
  created() {
    ...
    axiosReadMain(
      ...
      res => {
        ...
        // this.articles = res.data.slice(4);
