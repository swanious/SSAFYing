    ...
    <v-sheet>
      ...
      <div class="community__links">
        <div class="btn__group">
          ...
          <v-btn to="/board/anonymous">익명게시판 </v-btn>
          <v-btn id="active" to="/board/grade">기수게시판</v-btn>
        </div>
...
export default {
  ...
  methods: {
    ...
    writeArticle() {
      this.$router.push({
        name: "Register",
        params: { mainCategory: "community", subCategory: "grade" }
      });
    },
    viewArticle(item) {
      this.$router.replace({
